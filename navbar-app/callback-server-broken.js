...
const fet    // Exchange authorization code for tokens
    ...
    console.log('📋 Token endpoint:', tokenEndpoint);ode-fetch');
...
app.get('/callback', async (req, res) => {
  ...
  try {
    ...
    const clientId = 'IBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAq8W2KQ';
    const tokenEndpoint = 'http://localhost:8088/v1/esignet/oauth/v2/token';
